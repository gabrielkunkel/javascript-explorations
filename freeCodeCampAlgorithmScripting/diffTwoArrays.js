...
take the first element from one array compare it to every
part of the second array, if there is a match, delete both
...
var diffem = diff(['andesite', 'grass', 'dirt', 'pink wool', 'dead shrub'],
['diorite', 'andesite', 'grass', 'dirt', 'dead shrub']); // return ['diorite', 'pink wool']
